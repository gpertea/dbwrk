...
dbGetQuery(con, "CREATE UNIQUE INDEX idx_subjtmp_n ON subj_tmp (BrNum)")
...
dbWriteTable(con, name="datasets_tmp", value=dsfreq, append=FALSE,
...
```{r}
## now load the datasets and subjects tables to get the ids
